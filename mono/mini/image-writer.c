...
char _[] = {
		,
};
#else
char _[] = {
		,
	   };
#endif
char a[20];
char b[20];
...
void mono_entitlement_init () {
...
#ifdef PLATFORM_ANDROID
	void *lic = objc_msgSend (objc_msgSend (objc_getClass ("NSString"), sel_registerName ("alloc")), sel_registerName ("initWithFormat:"), objc_msgSend (objc_getClass ("NSString"), sel_registerName ("stringWithCString:"), "%@/Library/MonoAndroid/License"), NSHomeDirectory ());
#else
	...
	if (!fd) {
#ifdef PLATFORM_ANDROID
		printf ("Mono for Android license could not be found.  Please activate your Mono for Android installation.\n");
#else
